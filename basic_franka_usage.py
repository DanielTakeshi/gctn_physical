...
- Fine-tune various poses and waypoints for the robot.
"""
...
def finetune_pose(fa):
    ...
    # Move to our current top joint. Careful: duration and collisions.
    print(f'\nMove to JOINTS_TOP:\n{DC.JOINTS_TOP}')
    DU.wait_for_enter()
    ...
    #DU.rotate_EE_one_axis(fa, deg=-3, axis='x', duration=5)
    #DU.rotate_EE_one_axis(fa, deg=-4, axis='y', duration=5)
    #DU.rotate_EE_one_axis(fa, deg=4, axis='z', duration=5)
